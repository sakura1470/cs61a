    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.can_contain(self) and not self.can_contain(place.ant):
                ...
                place.ant is None, 'Two ants in {0}'.format(place)
            # END Problem 8
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        if self.place.bees :
            ...
            cur_place, cur_range = self.place, 0
            while cur_place:
                if self.min_range <= cur_range <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        Ant.reduce_health(self,ant_amount)
        # END Problem 5
